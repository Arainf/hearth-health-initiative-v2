...
@vite(['resources/css/rich-editor/editor.css', 'resources/js/page/generated.js', 'resources/css/app.css', 'resources/js/app.js',])
    <div class="flex flex-col h-full bg-[var(--bg)] overflow-hidden font-inter relative ml-[-4px]">

        <div class="flex items-center justify-between px-6 py-2 border-b border-[var(--text-muted)] bg-[var(--bg-light)] z-20 shadow-sm">
            <div class="flex items-center gap-4">
                <div>
                    <h3 class="text-lg font-semibold text-[var(--text)]">Generated Report</h3>
                </div>
            </div>
        ...
        @endif
        <div class="flex flex-row h-full relative editor-container overflow-y-auto self-center my-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] ">
        ...
        @if($record->status_id != 1)
            <div
                ...
                class="
                    ...
                    z-30
                    bg-[var(--bg-light)] backdrop-blur-md
