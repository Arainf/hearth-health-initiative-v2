<x-guest-layout>
    ...
    @guest
        <form method="POST" action="{{ route('login') }}" >
            ...
            <div class="relative w-[350px] flex flex-row items-center font-inter ">
                <x-lucide-user class="ml-3 w-4 h-4 text-[#092D69] absolute"/>
            ...
            <div class="relative mt-2 w-[350px]  flex flex-row items-center font-inter" >

                <x-lucide-lock class="ml-3 w-4 h-4 text-[#092D69] absolute"/>
            ...
            <x-input-error :messages="$errors->get('username')" class="mt-2 bottom-[-40%] font-inter" />
            <div class="flex items-center  mt-4  font-inter">
